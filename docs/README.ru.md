...
<li>Файлы, извлеченные с помощью меню "Открыть с помощью" ОС, по умолчанию сохраняются в <strong>Внутреннее хранилище/ZipXtract</strong>. Измените это в настройках приложения.</li>
...
<p>Разрешение на чтение и запись в хранилище (Android 10 и ниже) и управление разрешением на внешнее хранилище (Android 11 и выше). У приложения нет разрешения на интернет. Читайте больше - <a href="https://sites.google.com/view/privacy-policy-zipxtract/home">Политика конфиденциальности</a></p>
...
<h2>Лицензия</h2>
<p>Этот проект лицензирован под лицензией GNU General Public License v3.0. См. файл <a href="../LICENSE">LICENSE</a> для получения деталей.</p>

<h2>Контакт</h2>
<p>Для любых вопросов или отзывов, пожалуйста, откройте проблему в <a href="../issues">репозитории GitHub</a>.</p>
